...
if($result->num_rows>0){
	while($rows = $result->fetch_assoc()){
		...
		$datalist_options .= '<option value="'.$title.'['.$product_code.']">';
					...
					<table class="bill-page-table" id="billHeaderInfo" width="100%" border="0">
						<tr>
							<th width="65%">
								...
								<p>Address: <span contentEditable></span></p>
							...
							<th>
								<table>
									...
									<tr>
										<th>Invoice No.</th>
										<td><?php echo $GLOBALS['bill_no_prefix'];?> <span id="billNo"><?php echo $bill_number;?></span></td>
									</tr>
									<tr>
										<th>Date</th>
